...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Communistcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"communistcoin.tk", "dnsseed.communistcoin.tk"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"communistcointools.com", "testnet-seed.communistcointools.com"},
    {"xurious.com", "testnet-seed.cmc.xurious.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Communistcoin is probably already running."), addrBind.ToString().c_str());
        else
